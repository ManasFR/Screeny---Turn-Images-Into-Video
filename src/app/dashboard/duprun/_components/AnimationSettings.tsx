      ...
      {options.map(opt => (
        <button
          ...
          style={{
            ...
            border: '1px solid',
            borderColor: value === opt ? activeBorder : 'rgba(255,255,255,0.09)',
...
const SliderInput = ({
  ...
  return (
    <div>
      <div
        className="inline-flex items-center px-2 py-0.5 rounded-md mb-2"
        style={{
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div style={{
          ...
          <SliderInput value={zoomLevel} min={1} max={10} step={0.1}
            onChange={setZoomLevel} unit="×" accent="#6366f1" />
        </div>
        ...
        <div style={{
          ...
          <SliderInput value={zoomDuration} min={1000} max={10000} step={100}
            onChange={setZoomDuration} unit="ms" accent="#818cf8" />
        </div>
        ...
        <div style={{
          ...
          <SliderInput value={transitionDuration} min={500} max={5000} step={100}
            onChange={setTransitionDuration} unit="ms" accent="#a78bfa" />
        </div>

        {/* Transition Type */}
        <div>
          <Label>Transition Type</Label>
          <PillGroup options={TRANSITION_TYPES} value={transitionType}
            onChange={setTransitionType} accent="indigo" />
        </div>

        {/* Cursor Style */}
        <div>
          <Label>Cursor Style</Label>
          <PillGroup options={CURSOR_TYPES} value={cursorType}
            onChange={setCursorType} accent="violet" />
        </div>
